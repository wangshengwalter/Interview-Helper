...
class MicrophoneStream:
    ...
    def __enter__(self: object) -> object:
        ...
        self._audio_stream = self._audio_interface.open(
            ...
            # https://goo.gl/z757pE
            channels=self._audio_interface.get_device_info_by_index(42)["maxInputChannels"],
            rate=self._rate,
            input=True,
...
def main() -> None:
    ...
    for i in range(p.get_device_count()):
        ...
        if info['maxInputChannels'] > 0:
            print("This device can be used for input.")
        if info['maxOutputChannels'] > 0:
            print("This device can be used for output.")
        print("-----------------------")
    p.terminate()
